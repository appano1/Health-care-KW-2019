    ...
    b.push((
      <div>
        ...
        <div style={{ display: "inline" }}>
          ...
          <img src="/images/penguin.png" width="25" height="25" style={{ marginBottom: arrow_height }}></img>s
  ...
  return (
    ...
    <div className="statistics">
      ...
      <div className="radio-items">
        <div className="col-6">
          <input id="a1" className="only-sr checked" type="radio" name="temp1" value="주간" onChange={click} />
          <label htmlFor="a1" id="label1">주간</label>
        </div>
        <div className="col-6">
          <input id="a2" className="only-sr" type="radio" name="temp1" value="월간" onChange={click} />
          <label htmlFor="a2">월간</label>
        </div>
      </div>
